...
function(image, configAndSecrets, logbackXmlStr, java_ops=[], port=8081, metricsPort=8082, appname='stedsnavnear', tracingRatio=0.0, resources=defaultResources, replicas={}, worstCaseShutdownSeconds=-1, ingresses=[])
